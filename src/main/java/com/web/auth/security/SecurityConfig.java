...
import com.web.auth.security.jwt.JwtAuthenticationFilter;
import com.web.auth.security.jwt.JwtAuthorizationFilter;
...
import static com.web.auth.constants.SecurityConstants.BASIC_AUTH_LOGIN_URL;
...
public class SecurityConfig {
    ...
    private JwtAuthenticationFilter getAuthenticationFilter(AuthenticationManager authenticationManager) throws Exception {
        return new JwtAuthenticationFilter(authenticationManager, coreClient, objectMapper, refreshTokenService);
    }
